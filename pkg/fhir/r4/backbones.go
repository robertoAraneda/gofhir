...
type EffectEvidenceSynthesisCertainty struct {
	...
	CertaintySubcomponent []BackboneElement `json:"certaintySubcomponent,omitempty"`
}
...
type EffectEvidenceSynthesisEffectEstimate struct {
	...
	PrecisionEstimate []BackboneElement `json:"precisionEstimate,omitempty"`
}
...
type SubstanceSpecificationStructure struct {
	...
	Isotope []BackboneElement `json:"isotope,omitempty"`
	// Supporting literature
	Source []Reference `json:"source,omitempty"`
